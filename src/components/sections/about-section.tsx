...
export function AboutSection({
  ...
  return (
    <section id="about" className="border-y border-border bg-surface py-20 sm:py-28" aria-labelledby="about-title">
      <div className="content-shell grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
        ...
        <div>
          <h2 id="about-title" className="max-w-3xl text-3xl font-semibold leading-tight tracking-tight sm:text-5xl">
            {about.heading}
          </h2>
