    ...
    <section className="content-shell flex min-h-[50vh] flex-col justify-center py-20">
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <button
          type="button"
          onClick={reset}
          className="atlas-button inline-flex min-h-11 items-center bg-accent px-4 font-semibold text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)]"
        >
          {copy.retry}
        </button>
        <a
          className="atlas-button inline-flex min-h-11 items-center border border-border px-4 font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)]"
          href={blog.homeUrl}
        >
          {copy.blog}
        </a>
